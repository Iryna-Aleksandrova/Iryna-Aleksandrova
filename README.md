## Hi there  My name is Iryna!👋  <img width="240" height="239" alt="image" src="https://github.com/user-attachments/assets/4a5ceee1-6deb-43ed-89d9-35968822fd8e" />

Junior Front-End Developer with hands-on experience developing dynamic interfaces using HTML5, CSS3, JavaScript, React, Redux Node.js and MongoDB. A collaborative team player with strong problem-solving abilities and a commitment to writing maintainable and scalable front-end code. Always eager to learn new tools and stay updated with best practices.
